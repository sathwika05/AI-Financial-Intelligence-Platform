...
AUTHORED: list[EvalQuestion] = [
    ...
    EvalQuestion(
        ...
        sql_order_requirement="none",
        reference_answer=(
            "EOG Resources (EOG) has steady broker backing, maintaining "
            "Overweight and Equal-Weight ratings across major Wall Street "
            "brokers.\n\nExxonMobil (XOM) combines robust current market momentum "
            "with massive strategic deals, including a long-term midstream "
            "agreement with Targa Resources and upstream contract awards for "
            "Rovuma LNG Phase 1 development in Mozambique.\n\nChevron (CVX) offers "
            "strong long-term market outperformance, international asset "
            "expansion via Equinor's stake acquisition in Namibia, and price "
            "target hikes from Morgan Stanley.\n\nConocoPhillips (COP) is backed "
            "by widespread bullish analyst price target increases from Morgan "
            "Stanley and Argus Research, alongside key executive hires, though "
            "slightly tempered by a price target trim from Barclays.\n\nSLB N.V. "
            "(SLB) exhibits strong document sentiment and operational momentum, "
            "highlighted by a major Brunei Shell Petroleum contract award, "
            "long-term returns, and a DCF intrinsic discount."
        ),
        reference_contexts=[
            # EOG
    ...
    EvalQuestion(
        ...
        sql_order_requirement="none",
        reference_answer=(
            "AbbVie Inc. (ABBV) shows stellar operational execution and strong "
            "coverage momentum. AbbVie exceeded quarterly earnings expectations, "
            "while regulatory review for a new subcutaneous option for Skyrizi "
            "in Crohn's disease drives potential breakout sentiment alongside a "
            "$300 analyst price target.\n\nMerck & Co. (MRK) is supported by "
            "strong oncology momentum and top-tier analyst upgrades. Morgan "
            "Stanley upgraded MRK to Overweight with a $179 price target "
            "following positive Phase 3 results for its personalized melanoma "
            "vaccine combined with Keytruda, alongside BMO raising its target to "
            "$170, despite minor broker downgrades.\n\nJohnson & Johnson (JNJ) "
            "offers steady defensive characteristics. JNJ beat Q2 expectations, "
            "raised fiscal 2026 EPS guidance, and maintains a Moderate Buy "
            "consensus with a $268.22 target.\n\nPfizer Inc. (PFE) shows signs of "
            "stabilization. Pfizer beat Q2 expectations, progresses its obesity "
            "pipeline, and established a settlement program covering ~5,000 "
            "Depo-Provera lawsuit claims to reduce legal uncertainty.\n\nBristol "
            "Myers Squibb (BMY) secured accelerated FDA approval for its novel "
            "CELMoD therapy ZENBEXUS in multiple myeloma, but faces overhangs "
            "from a revived Celgene shareholder lawsuit and cooling AstraZeneca "
            "merger rumors."
        ),
        reference_contexts=[
            # ABBV
    ...
    EvalQuestion(
        ...
        reference_answer=(
            ...
            "backed by strong Q2 earnings beating EPS estimates ($4.53 EPS), "
            "though tempered by legal headwinds after losing a federal appellate "
            "court ruling on merchant antitrust arbitration.\n\nPayPal (PYPL) "
            "expands its payment volume through new higher-education tuition "
            "integrations for PayPal and Venmo and draws speculative takeover "
            "interest, though ongoing competitive pressure keeps analyst ratings "
            "at Hold.\n\nVisa (V) has no usable recent company document coverage "
            "in the corpus, preventing qualitative sentiment verification."
        ),
        reference_contexts=[
            # MA
    ...
    EvalQuestion(
        ...
        reference_answer=(
            ...
            "operational performance with digital sales momentum and bullish "
            "analyst price target revisions across major brokers.\n\nMcDonald's "
            "Corporation (MCD) is taking proactive menu innovation steps—such as "
            "introducing Red Bull beverage offerings and expanding its drink "
            "menu—to revitalize store traffic and support growth.\n\nStarbucks "
            "Corporation (SBUX) offers a solid historical compounder profile, "
            "but faces operational headwinds, including corporate workforce "
            "restructuring layoffs and international sales disruptions in "
            "Korea.\n\nTesla, Inc. (TSLA) faces share price pressure from heavy AI "
            "infrastructure capital-spending demands.\n\nNIKE, Inc. (NKE) is "
            "heavily weighted down by a severe drawdown from its peak, erasing "
            "$200B in market capitalization, and facing technical breakdown "
            "warnings."
        ),
        reference_contexts=[
            # AMZN
